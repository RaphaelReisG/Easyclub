...
<template>
    <Head title="Orçamento - Index" />

    <AuthenticatedLayout>
        <template #header>
            <div>
                <h2 class="inline-block font-semibold text-xl text-gray-800 leading-tight">Orçamentos</h2>

                <div v-if="$page.props.auth.user.userable_type === 'App\\Models\\Cliente'" class="p-6 text-gray-900">
                    <Botao_novo :href="route('orcamento.create')"></Botao_novo>
                </div>
