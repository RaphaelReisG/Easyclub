<script setup>
    ...
    const plano = usePage().props.plano;
    ...
    const submit = () => {
        var t = plano.id
        //alert("opa"+t);
        form.put(route('plano.update', {id: t}));
    };
</script>

<template>
    <Head title="Plano - Alterar" />

    <AuthenticatedLayout>
        <template #header>
            <div>
                <h2 class="inline-block font-semibold text-xl text-gray-800 leading-tight"> <Link class="underline" :href="route('plano.index')">Planos</Link> > Editar</h2>
            </div>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div v-if="$page.props.auth.user.userable_type === 'App\\Models\\Administrador'" class="p-6 text-gray-900">
                        ...
                        <p>Preencha o formulario abaixo para alterar os atributos de um plano no sistema.</p>
