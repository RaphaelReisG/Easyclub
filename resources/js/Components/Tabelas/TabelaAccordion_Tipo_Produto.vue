            ...
            <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                <div class="overflow-hidden">
                    <table class="min-w-full">
                        ...
                        <tbody data-accordion="collapse" v-for="(obj, index) in  $page.props.tipo_Produtos ">
                            <tr 
                            ...
                            >
                                ...
                                <td>
                                    <Botao_editar :href="route('tipo_produto.edit' , {id: obj.id})"></Botao_editar>
                                    <Botao_deletar destino="tipo_produto.destroy" :deleteId="obj.id"></Botao_deletar>
                                </td>
                            </tr>
